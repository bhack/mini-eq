...
class FakeMiniEqControl:
    ...
    def state(self) -> dict[str, GLib.Variant]:
        return {
            ...
            "curve_name": GLib.Variant("s", self.preset_name),
            "curve_status": GLib.Variant("s", "preset"),
            "curve_label": GLib.Variant("s", self.preset_name),
            "output_sink": GLib.Variant("s", "Demo Output"),
            "output_preset_name": GLib.Variant("s", self.output_preset_name),
            "output_preset_status": GLib.Variant("s", "applied"),
            "output_preset_label": GLib.Variant("s", f"Applied - {self.output_preset_name}"),
